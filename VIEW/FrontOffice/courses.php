...
try {
    ...
    // Query to join course and category tables
    $sql = "SELECT course.id_form, course.nom_form, course.description, course.price, 
                   category.name AS category_name, course.thumbnail_path 
            FROM course 
    ...
    $courses = []; // Initialize empty array to avoid errors in HTML
}
?>
                        ...
                        <div class="course-item bg-light">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                    <a href="course-details.php?id=<?php echo $course['id_form']; ?>" 
                                       class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" 
                                       style="border-radius: 30px 0 0 30px;">Read More</a>
                                    <a href="enroll.php?id=<?php echo $course['id_form']; ?>" 
