...
<head>
    ...
    <!-- custom stylesheet -->
    <link rel="stylesheet" href="custom_css/custom courses.css" />
...
<body class="sub_page">
    ...
    <section class="recently-viewed">
        <h2 style="margin: 50px 5px">Courses</h2>
        ...
        <div class="product-grid">
            ...
            <?php foreach ($courses as $course) { ?>
                ...
                <a href="#" class="product-card">
                    ...
                    <span class="course-info"><?php echo $course['course_description']; ?></span>
                    <?php if ($taskC->doesCourseHaveTask($course['course_id']) === true) { ?>
                        <p class="course-name" style="padding: 10px 0"><button class="btn btn-primary"  onclick="window.location.href='tasks.php?key_id=<?php echo $course['course_id']; ?>&key_type=course'">View Tasks</button></p>
                    <?php } ?>
