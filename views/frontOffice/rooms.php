...
<head>
    <meta charset="utf-8">
    <title>Wajahni - Wajahni HTML Template</title>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">All Rooms</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Explore Our Available Rooms</h1>
                <!-- Create Room Button -->
                <button class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#createRoomModal">
                    Join or Create Room
                </button>
            </div>
            <div class="row g-4">
                <!-- Dynamically Display Rooms -->
                <?php foreach ($listeRooms as $room) { ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="create_room.php" method="POST">
                       <input type="hidden" class="form-control" id="currentuser" name="currentuser" required value="<?php echo $currentuser; ?>">
                        <div class="mb-3">
                            <label for="roomName" class="form-label">Room Name</label>
                            <input type="text" class="form-control" id="roomName" name="nom" required>
                        </div>
                        <button type="submit" class="btn btn-primary">Join or Create</button>
                    </form>
                </div>
            </div>
        </div>
