...
<nav>
  <ul class="menu-aside">
    ...
    <li class="menu-item has-submenu active"> 
      ...
      <div class="submenu">
            <a href="addevent.php" class="nav-item nav-link active">Ajouter Evenment</a>
            <a href="updateevent.php" class="nav-item nav-link">Modifier evenment</a>
            <a href="deleteevent.php" class="nav-item nav-link">Supprimer evenment</a>
            <a href="eventlist.php" class="nav-item nav-link">Afficher evenment</a>
		  </div>
	...
	<div class="col-nav">
     <button class="btn btn-icon btn-mobile me-auto" data-trigger="#offcanvas_aside"> <i class="md-28 material-icons md-menu"></i> </button>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <form id="eventForm" action="http://localhost/MajdBenAbdallah/model/handle_request.php" method="POST">
